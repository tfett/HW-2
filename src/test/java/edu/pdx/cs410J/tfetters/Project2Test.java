...
public class Project2Test extends InvokeMainTestCase {
    ...
    public void testCleanPass() {
        MainMethodResult result = invokeMain("-print","United Airlines", "5678", "PDX",
                "6/28/2014", "6:05", "MIA", "6/28/2014", "00:15");
        assertEquals(new Integer(0), result.getExitCode());
    }

    @Test
    public void testNewParameter() {
        MainMethodResult result = invokeMain("-textFile", "/file.txt","United Airlines", "1234", "PDX",
    ...
    public void fileDoesNotExist() {
        MainMethodResult result = invokeMain("-textFile", "./test.txt","United Airlines", "1234", "PDX",
                "6/28/2014", "6:05", "SJC", "6/28/2014", "00:15");
        assertEquals(new Integer(0), result.getExitCode());
    }
    ...
    public void fileDoesExist() {
        MainMethodResult result = invokeMain("-textFile", "./test.txt","United Airlines", "5678", "PDX",
